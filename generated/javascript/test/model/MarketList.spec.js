...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBisqApi.MarketList();
  });
  ...
  describe('MarketList', function() {
    it('should create an instance of MarketList', function() {
      // uncomment below and update the code to test MarketList
      //var instane = new TheBisqApi.MarketList();
      //expect(instance).to.be.a(TheBisqApi.MarketList);
    });
