...
class BisqApi
{
    ...
    public function accountListWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\AccountList', $e->getResponseHeaders());
    ...
    {
        return $this->accountListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function currencyListWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\CurrencyList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->currencyListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function marketListWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\MarketList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->marketListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->moveFundsToBisqWalletAsyncWithHttpInfo($trade_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->offerCancelAsyncWithHttpInfo($offer_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function offerDetailWithHttpInfo($offer_id = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\OfferDetail', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->offerDetailAsyncWithHttpInfo($offer_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->offerListAsyncWithHttpInfo($market, $status, $whose, $start, $end, $limit)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->offerMakeAsyncWithHttpInfo($direction, $price_type, $market_pair, $amount, $min_amount, $payment_account_id, $percentage_from_market_price, $fixed_price)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function offerMakeRequest($direction, $price_type, $market_pair, $amount, $min_amount, $payment_account_id = null, $percentage_from_market_price = '0.0', $fixed_price = '0')
    {
        ...
        if ($direction === null) {
            throw new \InvalidArgumentException('Missing the required parameter $direction when calling offerMake');
        }
        // verify the required parameter 'price_type' is set
        if ($price_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $price_type when calling offerMake');
        }
        // verify the required parameter 'market_pair' is set
        if ($market_pair === null) {
            throw new \InvalidArgumentException('Missing the required parameter $market_pair when calling offerMake');
        }
        // verify the required parameter 'amount' is set
        if ($amount === null) {
            throw new \InvalidArgumentException('Missing the required parameter $amount when calling offerMake');
        }
        if ($amount > 200000000) {
        ...
        if ($min_amount === null) {
            throw new \InvalidArgumentException('Missing the required parameter $min_amount when calling offerMake');
        }
    ...
    {
        return $this->offerTakeAsyncWithHttpInfo($offer_id, $payment_account_id, $amount)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->paymentReceivedAsyncWithHttpInfo($trade_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->paymentStartedAsyncWithHttpInfo($trade_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->tradeDetailAsyncWithHttpInfo($trade_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->tradeListAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function walletAddressesWithHttpInfo($status = 'BOTH', $start = '0', $limit = '100')
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\WalletAddress[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->walletAddressesAsyncWithHttpInfo($status, $start, $limit)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function walletDetailWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\WalletDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->walletDetailAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function walletTransactionListWithHttpInfo($start = '0', $end = '2147483647', $limit = '100')
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\WalletTransactions', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->walletTransactionListAsyncWithHttpInfo($start, $end, $limit)->then(function ($response) {
            return $response[0];
        });
    }
